...
![Cygwin-1]( ./MyBlogBuildWay/Cygwin.PNG )

>直接安装一路默认

![Cygwin-2]( ./MyBlogBuildWay/Cygwin2.PNG )
![Cygwin-3]( ./MyBlogBuildWay/Cygwin3.PNG )
![Cygwin-4]( ./MyBlogBuildWay/Cygwin4.PNG )
![Cygwin-5]( ./MyBlogBuildWay/Cygwin5.PNG )

>这里推荐使用国内的镜像网站（找不到得自己添加）

![Cygwin-6]( ./MyBlogBuildWay/Cygwin6.PNG )
>这里是一些必须安装的包

![Cygwin-7]( ./MyBlogBuildWay/Cygwin7.PNG )
...
$ cygpath -w ~/
```
![Cygwin-8]( ./MyBlogBuildWay/Cygwin8.PNG )
...
错误原因：使用Markdown语法写的希腊字母在转义成HTML时，无法被HTML识别<br><br>
